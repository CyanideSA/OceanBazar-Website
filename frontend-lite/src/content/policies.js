  ...
  refunds: {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          'স্ট্যান্ডার্ড রিফান্ড সময়সীমা — অনুমোদনের পর ৭ থেকে ১০ কর্মদিবস',
          'বিকাশ / নগদ / রকেট / উপায় — সাধারণত ৩–৭ কর্মদিবসের মধ্যে',
          'SSLCommerz (কার্ড/ইন্টারনেট ব্যাংকিং) — ইস্যুকারী ব্যাংকের উপর নির্ভর করে ৭–১০ কর্মদিবস',
          'OB পয়েন্ট (যদি ব্যবহৃত হয়) — ২৪ ঘণ্টার মধ্যে পুনরুদ্ধার',
          'ক্যাশ অন ডেলিভারি — ৩–৭ কর্মদিবসের মধ্যে মোবাইল ওয়ালেটে রিফান্ড',
        ],
        highlight: 'অনুমোদিত রিফান্ড আমাদের টিম অনুমোদন করার তারিখ থেকে ৭ থেকে ১০ কর্মদিবসের মধ্যে সম্পন্ন হয়।',
      },
      {
        icon: 'scale',
        tag: 'conditions',
  ...
  shipping: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'অর্ডার নিশ্চিতকরণের পর:',
        bullets: [
          'ঢাকার ভিতরে — ৫ দিনের মধ্যে',
          'ঢাকার বাইরে — ১০ দিনের মধ্যে',
          'দূরবর্তী এলাকায় ঢাকার বাইরের সময়সীমা পর্যন্ত লাগতে পারে',
        ],
        highlight: 'ডেলিভারি সময়: ঢাকার ভিতরে — ৫ দিন · ঢাকার বাইরে — ১০ দিন।',
      },
      {
        icon: 'credit',
        tag: 'conditions',
