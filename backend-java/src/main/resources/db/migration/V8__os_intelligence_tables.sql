...
-- Idempotent mirror of Prisma migration 20260607000000_os_intelligence_layer.
-- Prisma is the source of truth; this file exists for Java-only / Flyway-first deploy paths.
-- All statements use IF NOT EXISTS guards so it is safe to run after Prisma has applied the same DDL.
